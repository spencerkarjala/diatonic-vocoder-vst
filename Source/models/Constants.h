...
namespace Constants {
    ...
    const std::string PARAM_IDS_HARMONIC_AMPLITUDE[12] = {
        "C-harmonic-amplitude",  "C#-harmonic-amplitude", "D-harmonic-amplitude",  "D#-harmonic-amplitude", "E-harmonic-amplitude",  "F-harmonic-amplitude",
        "F#-harmonic-amplitude", "G-harmonic-amplitude",  "G#-harmonic-amplitude", "A-harmonic-amplitude",  "A#-harmonic-amplitude", "B-harmonic-amplitude",
    };

    const std::string PARAM_LABELS_HARMONIC_AMPLITUDE[12] = {
        "C Amplitude",  "C# Amplitude", "D Amplitude",  "D# Amplitude", "E Amplitude",  "F Amplitude",
        "F# Amplitude", "G Amplitude",  "G# Amplitude", "A Amplitude",  "A# Amplitude", "B Amplitude",
    };
    ...
    const std::string PROJECT_NAME = "DiatonicVocoder";
}
